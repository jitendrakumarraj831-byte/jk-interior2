...
export const SERVICES_CONTENT: ServiceContent[] = [
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "Ceiling",
    categoryHi: "सीलिंग",
    tagline: "The showpiece ceiling for dry rooms — whatever design you dream, we frame it exactly",
    taglineHi: "सूखे कमरों की शोपीस सीलिंग — जो डिज़ाइन सोचें, हम बिल्कुल वैसा ढाँचा बनाते हैं",
    ...
    benefits: [
      "Fully made-to-order — hand us a sketch or a phone photo and we build that exact shape",
      "Taped-and-sanded finish reads as one seamless plane — the most premium ceiling look going",
      "Holds cove and LED profile lighting better than any other ceiling material",
      "Steps, curves, islands and trays are all on the table, not just flat",
      "Fire-resistant board that also softens noise travelling between floors",
    ],
    benefitsHi: [
      "पूरी तरह ऑर्डर पर बनती है — स्केच या मोबाइल फोटो दें, बिल्कुल वही शेप बनाते हैं",
      "टेप-सैंड फिनिश एक ही बिना-जोड़ सतह जैसी दिखती है — सबसे प्रीमियम छत लुक",
      "Cove और LED प्रोफाइल लाइट के लिए हर दूसरी छत से बेहतर मटेरियल",
      "Step, घुमाव, आइलैंड, Tray — सब संभव, सिर्फ फ्लैट तक सीमित नहीं",
      "आग-रोधी बोर्ड, जो फ्लोरों के बीच की आवाज़ भी कम करता है",
    ],
    limitations: [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "Ceiling",
    categoryHi: "सीलिंग",
    tagline: "Sealed, waterproof plastic panels — the ceiling we reach for in every kitchen and bathroom",
    taglineHi: "सील्ड, वॉटरप्रूफ प्लास्टिक पैनल — किचन और बाथरूम में हम यही पहले उठाते हैं",
    ...
    benefits: [
      "100% waterproof — bathroom, kitchen and balcony hold no fear",
      "Termites and insects don't touch plastic",
      "Zero upkeep — a wet cloth is the entire maintenance routine",
      "Keeps its colour and shape well past 20 years",
      "The quickest ceiling to install and the friendliest on price per sq.ft",
    ],
    benefitsHi: [
      "100% वॉटरप्रूफ — बाथरूम, किचन, बालकनी में कोई डर नहीं",
      "टर्माइट और कीड़े प्लास्टिक को छूते नहीं",
      "ज़ीरो देखभाल — गीला कपड़ा ही पूरी मेंटेनेंस",
      "20 साल से आगे तक रंग और शेप बनाए रखती है",
      "सबसे तेज़ लगने वाली और प्रति वर्ग फुट सबसे किफायती छत",
    ],
    limitations: [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "Ceiling",
    categoryHi: "सीलिंग",
    tagline: "The lift-out tile ceiling that keeps wiring and ducts one tile away",
    taglineHi: "उठाकर निकाल लेने वाली टाइल सीलिंग, जो वायरिंग-डक्ट को एक टाइल दूर रखे",
    ...
    benefits: [
      "Any tile lifts out and back in minutes — the easiest ceiling to service, full stop",
      "Purpose-built for floors with AC ducting, sprinklers or heavy wiring above",
      "Acoustic-rated tiles are available to cut office echo and noise",
      "Fastest ceiling to cover a large open floor",
      "The most economical choice per sq.ft on big commercial areas",
    ],
    benefitsHi: [
      "कोई भी टाइल मिनटों में निकाल-वापस लगती है — सर्विस के लिए सबसे आसान छत, बस",
      "AC डक्टिंग, स्प्रिंकलर या भारी वायरिंग वाले फ्लोर के लिए ख़ास बना",
      "ऑफिस की गूँज-शोर कम करने को एकॉस्टिक-रेटेड टाइल उपलब्ध",
      "बड़े खुले फ्लोर को ढकने वाली सबसे तेज़ छत",
      "बड़े कमर्शियल एरिया पर प्रति वर्ग फुट सबसे किफायती विकल्प",
    ],
    limitations: [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "Partition",
    categoryHi: "पार्टीशन",
    tagline: "Turn one room into two in days — no bricks, no cement, no touching the slab",
    taglineHi: "एक कमरे को दिनों में दो बनाएं — न ईंट, न सीमेंट, न स्लैब छेड़ें",
    ...
    benefits: [
      "No bricklaying and no wet work — a room divides in days, not weeks",
      "The gypsum face carries wall units and shelves like any normal wall",
      "Glass keeps the room feeling open and lets daylight travel across it",
      "Both types can be taken down and reworked if your layout changes",
      "Rockwool infill delivers real, measurable sound reduction between cabins",
    ],
    benefitsHi: [
      "न ईंट का काम, न गीला काम — कमरा दिनों में बँटता है, हफ़्तों में नहीं",
      "Gypsum फेस दीवार जैसी यूनिट-शेल्फ सहती है",
      "ग्लास कमरे को खुला रखती है, रोशनी आर-पार जाती है",
      "दोनों उतारे और दोबारा बनाए जा सकते हैं, लेआउट बदलना आसान",
      "रॉकवूल इनफिल केबिनों के बीच सच में नापने लायक शोर कम करता है",
    ],
    limitations: [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "Wall",
    categoryHi: "वॉल",
    tagline: "The real-wood TV wall that shrugs off Bihar's damp — at roughly 60% of timber",
    taglineHi: "असली लकड़ी जैसी TV वॉल, जो बिहार की नमी झेले — टिम्बर से करीब 60% कम में",
    ...
    benefits: [
      "A premium wood look for roughly 60% of what real timber panelling costs",
      "Moisture and termite resistant — outlives natural wood in a monsoon climate",
      "Zero maintenance — no polishing or varnishing, ever",
      "Clip-fixed install leaves no nail or screw heads on the face",
      "50+ colours and textures, including the trending fluted and louvre profiles",
    ],
    benefitsHi: [
      "असली टिम्बर पैनलिंग से करीब 60% कम में प्रीमियम लकड़ी लुक",
      "नमी और दीमक-रोधी — मानसून जलवायु में असली लकड़ी से ज़्यादा टिकाऊ",
      "ज़ीरो देखभाल — कभी पॉलिश या वार्निश नहीं",
      "क्लिप-फिक्स इंस्टॉल, फेस पर कोई कील-स्क्रू सिर नहीं",
      "50+ रंग-टेक्सचर, ट्रेंडिंग Fluted और Louver प्रोफाइल समेत",
    ],
    limitations: [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "Wall",
    categoryHi: "वॉल",
    tagline: "A seamless, waterproof marble wall for pooja rooms and baths — no stone, no grout lines",
    taglineHi: "पूजा घर और बाथरूम की बिना-जोड़, वॉटरप्रूफ मार्बल दीवार — न पत्थर, न ग्राउट लाइन",
    ...
    benefits: [
      "A real marble or granite look for roughly 70–80% less than genuine stone",
      "100% waterproof — made for bathroom and kitchen walls",
      "No grout lines means it stays clean far longer than tile",
      "Lightweight — it puts no structural load on the wall",
      "Scratch-resistant, hygienic and wipe-clean",
    ],
    benefitsHi: [
      "असली मार्बल या ग्रेनाइट लुक, असली पत्थर से करीब 70–80% कम में",
      "100% वॉटरप्रूफ — बाथरूम और किचन की दीवार के लिए बना",
      "कोई ग्राउट लाइन नहीं, तो टाइल से कहीं ज़्यादा देर साफ रहती है",
      "हल्की — दीवार पर कोई स्ट्रक्चरल भार नहीं",
      "स्क्रैच-रोधी, स्वच्छ और पोंछकर साफ",
    ],
    limitations: [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "Furniture",
    categoryHi: "फर्नीचर",
    tagline: "A TV cabinet built to your wall's exact width — never a catalogue piece cut to fit",
    taglineHi: "आपकी दीवार की सही चौड़ाई पर बनी TV कैबिनेट — कैटलॉग पीस को काटकर फिट नहीं",
    ...
    benefits: [
      "Fits your wall's exact width — no awkward side gaps like an off-the-shelf unit",
      "Cable management is built in, so there's no visible wiring clutter",
      "An optional LED strip gives it that floating, showroom glow",
      "A mix of closed cabinets and open shelves, sized to what you actually store",
      "Finish, colour and hardware are all your call, not the factory's",
    ],
    benefitsHi: [
      "आपकी दीवार की सही चौड़ाई में फिट — रेडीमेड यूनिट जैसी अजीब साइड-गैप नहीं",
      "केबल मैनेजमेंट बिल्ट-इन, तो कोई दिखने वाला तार-जंजाल नहीं",
      "वैकल्पिक LED स्ट्रिप वो फ्लोटिंग, शोरूम ग्लो देती है",
      "बंद कैबिनेट और खुली शेल्फ का मिश्रण, जो आप सच में रखते हैं उसके नाप पर",
      "फिनिश, रंग और हार्डवेयर — सब आपकी पसंद, फैक्ट्री की नहीं",
    ],
    limitations: [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "Outdoor",
    categoryHi: "आउटडोर",
    tagline: "An evergreen balcony or green wall that drains the monsoon and never needs watering",
    taglineHi: "हमेशा हरी बालकनी या ग्रीन वॉल, जो मानसून का पानी निकाले और पानी माँगे नहीं",
    ...
    benefits: [
      "Always green — no seasonal browning and no watering schedule to keep",
      "Drains straight through rather than pooling — made for Bihar's monsoon",
      "UV-treated colour lasts far longer than untreated turf",
      "No mowing, no fertiliser, no pest spraying, ever",
      "Pet-friendly and far kinder underfoot than bare tile",
    ],
    benefitsHi: [
      "हमेशा हरी — न मौसमी पीलापन, न पानी देने का शेड्यूल",
      "जमा होने की जगह सीधे निकल जाती है — बिहार के मानसून के लिए बनी",
      "UV-ट्रीटेड रंग अनट्रीटेड टर्फ से कहीं ज़्यादा टिकता है",
      "न कटाई, न खाद, न कीट स्प्रे, कभी नहीं",
      "पालतू-अनुकूल और नंगे टाइल से पैरों तले कहीं आरामदेह",
    ],
    limitations: [
