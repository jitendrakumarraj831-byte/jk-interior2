...
export const SERVICES_CONTENT: ServiceContent[] = [
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    taglineHi: "सादी छत को डिज़ाइनर सीलिंग बनाएं — बिना जोड़, Cove लाइट वाली, आपके चुने डिज़ाइन पर",
    ...
    whatItIsHi:
      "जिप्सम बोर्ड और जंग-रहित मेटल फ्रेम की बिना-जोड़ डिज़ाइनर सीलिंग — वो स्मूथ, बिना-दरार फिनिश जो हॉल को साफ-सुथरा और पूरा लुक दे, छुपी Cove और LED लाइट के साथ।",
    whereUsed: [
    ...
    benefitsHi: [
      "बिना-जोड़, बिना-दरार फिनिश जो हॉल को साफ-सुथरा, पूरा लुक दे",
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    taglineHi: "सागवान-अखरोट जैसी लकड़ी वाली दीवार, असली लकड़ी से काफ़ी कम में — नमी और दीमक-रोधी",
    ...
    whatItIsHi:
      "डिज़ाइनर वुड-लुक पैनल, जो आपकी TV या फीचर वॉल को असली लकड़ी जैसी गर्माहट दें — पर नमी-रोधी, स्क्रैच-रोधी और बिहार की जलवायु में दीमक-मुड़ाव से काफ़ी हद तक सुरक्षित।",
    whereUsed: [
    ...
    benefitsHi: [
      "सागवान/अखरोट जैसी लकड़ी का लुक, असली लकड़ी से काफ़ी कम कीमत में",
      "नमी और दीमक-रोधी — असली लकड़ी से कहीं कम मुड़ने-फूलने-सड़ने वाला",
      "बहुत कम देखभाल — पॉलिश-वार्निश नहीं, बस पोंछ दीजिए",
      "प्रीमियम टेक्सचर की अच्छी रेंज, ट्रेंडिंग Fluted और LED Louver समेत",
      "फीचर वॉल जो कमरा निखार दे, आमतौर पर एक दिन में तैयार",
    ],
    limitations: [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    taglineHi: "बिना भारी पत्थर, तोड़-फोड़ और भारी खर्च के — दीवारों पर मार्बल जैसा लुक",
    ...
    whatItIsHi:
      "शीशे जैसी चमकदार, बिना-जोड़ मार्बल-लुक दीवार, आपके पूजा घर या बाथरूम के लिए — पूरी तरह वॉटरप्रूफ, काली पड़ने वाली ग्राउट लाइन नहीं, असली मार्बल से बहुत कम कीमत में।",
    whereUsed: [
    ...
    benefitsHi: [
      "असली पत्थर की कीमत के एक हिस्से में प्रीमियम मार्बल लुक",
      "हाई-ग्लॉस फिनिश, जो रोशनी परावर्तित कर पूरा कमरा उजला करे",
      "वॉटरप्रूफ, कोई ग्राउट लाइन नहीं — सालों साफ और बेदाग",
      "हल्की, स्क्रैच-रोधी और सेकंडों में पोंछकर साफ",
      "एक ही दिन में, बिना धूल, नई दीवार का मेकओवर",
    ],
    limitations: [
