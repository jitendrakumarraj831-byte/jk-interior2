...
export const PRICE_DISCLAIMER_HI =
  "ऊपर दिए गए सभी रेट फारबिसगंज/अररिया ज़िले के लोकल मार्केट के अनुमानित रेट हैं, फिक्स्ड कोटेशन नहीं। आपके काम की असली कीमत फ्री साइट विज़िट और माप, चुने गए डिज़ाइन, मटेरियल क्वालिटी टियर, कमरे तक पहुंच, और कुल प्रोजेक्ट साइज़ पर निर्भर करती है — बड़ा ऑर्डर या कॉम्बो बुकिंग (सीलिंग + वॉल + TV यूनिट साथ में) आमतौर पर प्रति वर्ग फुट सस्ता पड़ता है।"
...
export const SERVICES_CONTENT: ServiceContent[] = [
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    priceTiers: [
      { tier: "Economy", tierHi: "इकोनॉमी", range: "₹75–₹90/sq.ft", desc: "Flat, single-level ceiling with a plain matte paint finish — standard 12.5mm board, no cove.", descHi: "फ्लैट, सिंगल-लेवल सीलिंग, प्लेन मैट पेंट फिनिश — स्टैंडर्ड 12.5mm बोर्ड, कोई कोव नहीं।" },
      { tier: "Standard", tierHi: "स्टैंडर्ड", range: "₹95–₹130/sq.ft", desc: "One stepped border with a basic cove channel (LED strip billed separately) and a smoother finish coat.", descHi: "एक सीढ़ीदार बॉर्डर, बेसिक कोव चैनल के साथ (LED स्ट्रिप अलग से) और ज़्यादा स्मूथ फिनिश कोट।" },
      { tier: "Premium", tierHi: "प्रीमियम", range: "₹135–₹210/sq.ft", desc: "Multi-level or curved tray design with integrated LED cove lighting and a premium textured/metallic paint finish.", descHi: "मल्टी-लेवल या घुमावदार ट्रे डिज़ाइन, बिल्ट-इन LED कोव लाइटिंग और प्रीमियम टेक्सचर्ड/मेटैलिक पेंट फिनिश।" },
    ],
    ...
    sizesThicknessHi: "जिप्सम बोर्ड स्टैंडर्ड 12.5mm मोटा होता है, 1200×2400mm (4×8 फुट) और 1200×1800mm (4×6 फुट) शीट में, साइट पर काटा जाता है। पतला 8mm बोर्ड सिर्फ घुमावदार/फॉल्स-ड्रॉप हिस्सों में इस्तेमाल होता है।",
    ...
    labourCostHi: "लेबर (फ्रेमिंग, बोर्ड फिक्सिंग, टेपिंग, पेंट फिनिश) ऊपर दिए रेट में शामिल है, कुल का करीब ₹30–45/sq.ft हिस्सा लेबर का होता है — कोव और मल्टी-लेवल डिज़ाइन में ज़्यादा फ्रेमिंग-फिनिशिंग की वजह से यह ज़्यादा रहता है।",
    ...
    availabilityHi: "हमारे पूरे सर्विस एरिया में उपलब्ध — फारबिसगंज, अररिया, जोगबनी, रानीगंज, नरपतगंज, पूर्णिया, सुपौल, त्रिवेणीगंज, कुर्साकांटा और छातापुर। कोव-लाइटिंग और मल्टी-लेवल डिज़ाइन फारबिसगंज और अररिया टाउन में सबसे ज़्यादा मांगे जाते हैं; बाकी जगहों में स्टैंडर्ड फ्लैट सीलिंग ज़्यादा चलती है।",
    ...
    whereUsedHi: [
      ...
      "बेडरूम — सॉफ्ट कोव लाइटिंग से कमरा ज़्यादा शांत और गर्म लगता है",
    ...
    benefitsHi: [
      "बिल्कुल स्मूथ, बिना जोड़ वाली फिनिश — सबसे प्रीमियम लुक",
      "कोई भी शेप संभव: कोव, स्टेप, घुमावदार, ट्रे सीलिंग",
      "कोव/LED स्ट्रिप लाइटिंग के लिए सबसे बेहतर मटेरियल",
      "किसी भी रंग में पेंट हो सकती है, और बाद में दोबारा पेंट भी हो सकती है",
      "आग-रोधी बोर्ड, और PVC से ज़्यादा अच्छी ध्वनि रोधन",
    ],
    limitations: [
    ...
    limitationsHi: [
      ...
      "समान डिज़ाइन में PVC से थोड़ा ज़्यादा लेबर खर्च आता है",
    ],
    materials: [
      ...
      { name: "Joint tape & jointing compound", nameHi: "जॉइंट टेप और जॉइंटिंग कंपाउंड", detail: "Seals every board joint so the finished surface reads as one continuous plane", detailHi: "हर बोर्ड जोड़ को सील करता है ताकि पूरी सतह एक जैसी स्मूथ दिखे" },
      { name: "LED cove profile + strip", nameHi: "LED कोव प्रोफाइल + स्ट्रिप", detail: "Aluminium channel recessed into the cove step, warm-white (3000K) for living areas", detailHi: "कोव स्टेप में लगा एल्युमिनियम चैनल, लिविंग एरिया के लिए वार्म-व्हाइट (3000K)" },
    ],
    installSteps: [
      { title: "Level marking", titleHi: "लेवल मार्किंग", desc: "We mark a laser/spirit-level line around the room at the drop height agreed with you.", descHi: "आपसे तय की गई ड्रॉप-हाइट पर पूरे कमरे में लेज़र/स्पिरिट-लेवल से लाइन मार्क करते हैं।" },
      ...
      { title: "Cove framing (if in design)", titleHi: "कोव फ्रेमिंग (अगर डिज़ाइन में है)", desc: "A recessed step is framed at the border for the LED strip before the boards on that section close.", descHi: "LED स्ट्रिप के लिए बॉर्डर पर एक रिसेस्ड स्टेप बनाया जाता है, उस हिस्से के बोर्ड बंद होने से पहले।" },
      { title: "Taping & jointing", titleHi: "टेपिंग और जॉइंटिंग", desc: "Paper tape and jointing compound cover every screw head and board joint, then get sanded flat.", descHi: "हर स्क्रू और जोड़ पर पेपर टेप और जॉइंटिंग कंपाउंड लगता है, फिर सैंड करके स्मूथ किया जाता है।" },
    ...
    realProject: {
      ...
      descHi: "180 वर्ग फुट के ड्रॉइंग रूम में सीढ़ीदार जिप्सम बॉर्डर और वार्म-व्हाइट LED कोव लगाई गई — यही प्रोजेक्ट हमारी टीम अक्सर साइट पर दिखाती है ताकि ग्राहक कोव लाइटिंग का असली लुक समझ सकें।",
      photos: 16,
    },
    faqs: [
      ...
      { q: "Can I get gypsum ceiling and cove lighting done on a tight budget?", qHi: "कम बजट में भी जिप्सम सीलिंग और कोव लाइटिंग हो सकती है?", a: "Yes — a plain gypsum ceiling without cove detailing starts at the base ₹80/sq.ft rate. Cove lighting adds roughly ₹40–80 per running foot of the border, not the whole ceiling area, so you can add it to just the main wall and skip it elsewhere.", aHi: "हां — बिना कोव के प्लेन जिप्सम सीलिंग ₹80/sq.ft से शुरू होती है। कोव लाइटिंग पूरी सीलिंग पर नहीं, सिर्फ बॉर्डर की रनिंग फुट पर ₹40–80 अतिरिक्त लगती है, तो आप सिर्फ मुख्य दीवार पर लगवा कर बाकी जगह छोड़ सकते हैं।" },
      { q: "How is gypsum different from POP (Plaster of Paris)?", qHi: "जिप्सम, POP से कैसे अलग है?", a: "POP is wet plaster applied directly by hand, so its finish depends heavily on the mason's skill and it takes longer to dry and cure. Gypsum board is a factory-made panel screwed onto a frame — the finish is more uniform, installation is faster, and it's easier to later remove a section for repair without redoing the whole ceiling.", aHi: "POP सीधे हाथ से लगाया गया गीला प्लास्टर होता है, इसकी फिनिश मिस्त्री के हुनर पर निर्भर करती है और सूखने में समय लगता है। जिप्सम बोर्ड फैक्ट्री में बना पैनल है जो फ्रेम पर स्क्रू होता है — फिनिश ज़्यादा एक समान होती है, इंस्टॉलेशन तेज़ होता है, और बाद में सिर्फ एक हिस्सा निकालकर रिपेयर करना भी आसान होता है।" },
      { q: "Does gypsum ceiling reduce room height noticeably?", qHi: "क्या जिप्सम सीलिंग से कमरे की ऊंचाई कम हो जाती है?", a: "A flat gypsum ceiling typically drops the height by 3–4 inches for the frame and board. If your room already has low ceilings, tell us before the site visit — we'll suggest a shallower frame or recommend PVC instead, which needs less drop.", aHi: "एक फ्लैट जिप्सम सीलिंग आमतौर पर फ्रेम और बोर्ड की वजह से 3–4 इंच ऊंचाई कम करती है। अगर आपके कमरे की ऊंचाई पहले से कम है, तो साइट विज़िट से पहले बताएं — हम कम ड्रॉप वाला फ्रेम या PVC सुझाएंगे, जिसमें कम जगह चाहिए।" },
    ],
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    priceTiers: [
      ...
      { tier: "Premium", tierHi: "प्रीमियम", range: "₹120–₹150/sq.ft", desc: "Designer 3D/embossed or high-gloss panels, 8mm gauge, heavier-duty grid for larger spans.", descHi: "डिज़ाइनर 3D/एम्बॉस्ड या हाई-ग्लॉस पैनल, 8mm गेज, बड़े स्पैन के लिए मज़बूत ग्रिड।" },
    ],
    ...
    brandNoteHi: "पैनल फारबिसगंज/पूर्णिया के अधिकृत सप्लायर से ISI-अनुरूप ब्रांडेड PVC स्टॉक होते हैं, कुछ छोटे ठेकेदारों के इस्तेमाल किए सस्ते अनब्रांडेड इम्पोर्ट नहीं — हम साइट पर पैनल सैंपल और उसकी बैच मार्किंग दिखाते हैं।",
    ...
    whereUsedHi: [
      ...
      "सच कहें तो कोई भी कमरा — यह सबसे बहुउपयोगी विकल्प है",
    ],
    whereNotUsed: [
    ...
    whereNotUsedHi: [
      "मजबूती के लिहाज से कहीं मना नहीं — पर जिन हॉल में कोव/POP जैसा जटिल डिज़ाइन चाहिए, वहां जिप्सम बेहतर रहेगी",
      "जहां आप हर कुछ साल में सीलिंग का रंग बदलना चाहते हों — वहां पेंट होने वाली जिप्सम बेहतर विकल्प है",
    ],
    benefits: [
    ...
    limitationsHi: [
      "डिज़ाइन के विकल्प जिप्सम जितने नहीं — जटिल कोव या घुमावदार शेप नहीं बन सकते",
      ...
      "फॉर्मल ड्रॉइंग रूम में जिप्सम जितना प्रीमियम लुक नहीं देता",
    ],
    materials: [
    ...
    installSteps: [
      ...
      { title: "Panel fixing", titleHi: "पैनल फिक्सिंग", desc: "Panels are cut to length and clipped into the grid one by one, tongue-and-groove interlocked.", descHi: "पैनल को नाप के हिसाब से काटकर एक-एक करके ग्रिड में क्लिप किया जाता है, टंग-एंड-ग्रूव से जुड़ते हैं।" },
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    priceTiers: [
      ...
      { tier: "Standard", tierHi: "स्टैंडर्ड", range: "₹56–₹75/sq.ft", desc: "Better mineral-fibre or PVC lay-in tile with some moisture resistance.", descHi: "थोड़ी नमी-रोधी बेहतर मिनरल-फाइबर या PVC ले-इन टाइल।" },
      { tier: "Premium", tierHi: "प्रीमियम", range: "₹76–₹115/sq.ft", desc: "Acoustic-rated or edge-lit tiles on a heavier-gauge grid.", descHi: "भारी-गेज ग्रिड पर एकॉस्टिक-रेटेड या एज-लिट टाइल।" },
    ],
    ...
    sizesThicknessHi: "टाइल इंडस्ट्री-स्टैंडर्ड 2×2 फुट (600×600mm) ले-इन साइज़ में, मोटाई टियर के हिसाब से 15–19mm (एकॉस्टिक टाइल ज़्यादा मोटी)। ग्रिड रनर स्टैंडर्ड 24mm-फेस T-सेक्शन के होते हैं।",
    ...
    brandNoteHi: "ग्रिड कंपोनेंट और टाइल हमारे नियमित पूर्णिया-मार्केट सप्लायर से ISI/BIS-अनुरूप ब्रांडेड स्टॉक होते हैं — ऑर्डर से पहले साइट विज़िट में सही मेक दिखाकर कन्फर्म किया जाता है।",
    ...
    availabilityHi: "फारबिसगंज, अररिया और पूर्णिया के ऑफिस-दुकानों में सबसे ज़्यादा लगती है; जोगबनी, रानीगंज, नरपतगंज, सुपौल और आस-पास के ब्लॉक में भी। एकॉस्टिक/एज-लिट टाइल दूर के इलाकों में 2–3 दिन ज़्यादा लग सकते हैं क्योंकि ये पूर्णिया से मंगाई जाती हैं।",
    ...
    whereUsedHi: [
      "ऑफिस, कॉर्पोरेट केबिन और कोवर्किंग स्पेस",
    ...
    whereNotUsedHi: [
      "फॉर्मल लिविंग रूम या बेडरूम जहां बिना जोड़ वाली, प्रीमियम लुक ज़्यादा मायने रखता है",
    ...
    benefitsHi: [
      ...
      "एकॉस्टिक-रेटेड टाइल भी मिलते हैं जहां शोर/गूंज कम करनी हो (खुले ऑफिस, वेटिंग एरिया)",
    ...
    limitationsHi: [
      "ग्रिड की लाइनें दिखती हैं — यह एक व्यावहारिक सीलिंग है, सजावटी नहीं, और वैसी ही दिखती है",
      ...
      "डिज़ाइन के विकल्प कम — कोव लाइटिंग या घुमावदार शेप संभव नहीं",
    ],
    materials: [
      ...
      { name: "Perimeter wall angle", nameHi: "पेरीमीटर वॉल एंगल", detail: "L-shaped angle fixed along the wall at ceiling height that the grid rests on at the edges", detailHi: "दीवार पर सीलिंग हाइट पर लगा L-आकार का एंगल, जिस पर किनारों पर ग्रिड टिकता है" },
    ],
    installSteps: [
      { title: "Level marking", titleHi: "लेवल मार्किंग", desc: "Ceiling drop height marked on the walls all around the room or floor.", descHi: "कमरे या फ्लोर के चारों ओर दीवारों पर सीलिंग ड्रॉप-हाइट मार्क की जाती है।" },
      ...
      { title: "Grid levelling", titleHi: "ग्रिड लेवलिंग", desc: "Every wire is fine-adjusted so the whole grid sits dead level before any tile goes in.", descHi: "टाइल लगाने से पहले हर वायर को फाइन-अड्जस्ट करके पूरे ग्रिड को बिल्कुल लेवल किया जाता है।" },
      ...
      { title: "Final check & handover", titleHi: "फाइनल जांच और हैंडओवर", desc: "Every tile checked for a snug, level fit before handover.", descHi: "हैंडओवर से पहले हर टाइल को अच्छे से फिट और लेवल चेक किया जाता है।" },
    ],
    realProject: {
      ...
      descHi: "400 वर्ग फुट के डायग्नोस्टिक सेंटर फ्लोर में एकॉस्टिक मिनरल-फाइबर ग्रिड सीलिंग लगाई गई — टाइल खासतौर पर इसलिए चुनी गई ताकि भविष्य में AC या वायरिंग के काम के लिए सीलिंग तोड़नी न पड़े।",
      photos: 7,
    },
    faqs: [
      { q: "Why would I choose grid ceiling over gypsum for my office?", qHi: "ऑफिस के लिए जिप्सम की जगह ग्रिड सीलिंग क्यों चुनें?", a: "If your office has AC ducting, electrical conduits, or plumbing running above the ceiling that might need servicing later, grid ceiling lets an electrician lift one tile and get in without touching the rest of the ceiling. Gypsum looks more premium but means cutting into the board for any future access.", aHi: "अगर आपके ऑफिस में AC डक्टिंग, इलेक्ट्रिकल कंड्यूट या प्लंबिंग सीलिंग के ऊपर से गुज़रती है जिसे बाद में सर्विस करना पड़ सकता है, तो ग्रिड सीलिंग में इलेक्ट्रीशियन सिर्फ एक टाइल उठाकर बाकी सीलिंग को छुए बिना काम कर सकता है। जिप्सम ज़्यादा प्रीमियम दिखती है लेकिन भविष्य में एक्सेस के लिए बोर्ड काटना पड़ता है।" },
      { q: "Are grid ceiling tiles waterproof?", qHi: "क्या ग्रिड सीलिंग की टाइल वॉटरप्रूफ होती है?", a: "Standard mineral fibre tiles are not — they'll sag if they stay wet. If your space has any moisture exposure, we'll fit PVC lay-in tiles into the same grid instead, which handle damp without a problem.", aHi: "स्टैंडर्ड मिनरल फाइबर टाइल वॉटरप्रूफ नहीं होती — लगातार गीली रहने पर झुक जाती है। अगर आपकी जगह में नमी की संभावना है, तो हम उसी ग्रिड में PVC ले-इन टाइल लगा देते हैं, जो नमी में भी ठीक रहती है।" },
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    priceTiers: [
      ...
      { tier: "Standard", tierHi: "स्टैंडर्ड", range: "₹135–₹200/sq.ft (gypsum) · ₹380–₹450/sq.ft (entry glass)", desc: "Double-layer gypsum with rockwool acoustic infill, or an entry-level plain toughened-glass screen.", descHi: "रॉकवूल एकॉस्टिक इनफिल के साथ डबल-लेयर जिप्सम, या एंट्री-लेवल प्लेन टफन्ड ग्लास स्क्रीन।" },
      { tier: "Premium", tierHi: "प्रीमियम", range: "₹460–₹750/sq.ft", desc: "Frosted or fluted-film glass partition with aluminium framing and a flush door, or a fully finished acoustic gypsum partition with premium paint.", descHi: "एल्युमिनियम फ्रेमिंग और फ्लश दरवाज़ा के साथ फ्रॉस्टेड/फ्लूटेड-फिल्म ग्लास पार्टीशन, या प्रीमियम पेंट वाली पूरी एकॉस्टिक जिप्सम पार्टीशन।" },
    ],
    ...
    sizesThicknessHi: "जिप्सम पार्टीशन में 50mm/75mm मेटल स्टड फ्रेमिंग पर 12.5mm बोर्ड (सिंगल या डबल लेयर) लगता है। ग्लास पार्टीशन में एल्युमिनियम चैनल फ्रेमिंग में 8–12mm टफन्ड सेफ्टी ग्लास लगता है।",
    ...
    labourCostHi: "लेबर (स्टड फ्रेमिंग, बोर्ड/ग्लास फिक्सिंग, फिनिशिंग, दरवाज़ा फिटिंग अगर हो) जिप्सम में करीब ₹25–40/sq.ft और ग्लास में ₹60–100/sq.ft, ऊपर के रेट में शामिल — ग्लास में हैंडलिंग और सटीक चैनल अलाइनमेंट की वजह से लेबर ज़्यादा लगता है।",
    ...
    brandNoteHi: "मेटल फ्रेमिंग, जिप्सम बोर्ड और टफन्ड ग्लास पूर्णिया और फारबिसगंज के ISI/BIS-अनुरूप अधिकृत डीलरों से लिए जाते हैं — ग्लास हमेशा टफन्ड सेफ्टी ग्लास होता है, कभी प्लेन एनील्ड शीट नहीं।",
    ...
    availabilityHi: "जिप्सम पार्टीशन हमारे पूरे सर्विस एरिया में लगती है। ग्लास पार्टीशन सबसे ज़्यादा फारबिसगंज और अररिया टाउन के ऑफिस में मांगी जाती है; बाकी शहरों में 2–4 दिन ज़्यादा लगेंगे क्योंकि ग्लास पूर्णिया से काटकर लाई जाती है।",
    ...
    whatItIsHi:
      "पार्टीशन वॉल किसी मौजूदा कमरे के अंदर, बिना फर्श या स्लैब में मेसनरी (ईंट-गारा) का काम किए, एक नई विभाजक दीवार बनाती है। हम इसे दो तरीकों से बनाते हैं: जिप्सम बोर्ड पार्टीशन — फर्श से छत तक मेटल स्टड फ्रेमिंग जिसके दोनों तरफ जिप्सम बोर्ड लगाकर एक सामान्य दीवार जैसा फिनिश किया जाता है — या ग्लास पार्टीशन — एल्युमिनियम फ्रेम में टफन्ड ग्लास की स्क्रीन, जो जगह बांटती है पर रोशनी और नज़र को खुला रखती है।",
    whereUsed: [
    ...
    whereUsedHi: [
      ...
      "बड़े बेडरूम को स्टडी नुक या वॉक-इन वार्डरोब बनाने के लिए बांटना (जिप्सम पार्टीशन)",
    ...
    whereNotUsedHi: [
      "ऐसी जगह जहां पार्टीशन को स्ट्रक्चरल वज़न सहना पड़े — यह सिर्फ गैर-स्ट्रक्चरल दीवार है",
      "छोटे बच्चों वाले घर में बिना सेफ्टी फिल्म के फुल-हाइट ग्लास पार्टीशन — वहां हम सेफ्टी-लैमिनेटेड ग्लास लगाते हैं",
      "गीली जगह की बाउंड्री (बाथरूम की दीवार) — वहां मेसनरी दीवार या PVC पैनल सिस्टम इस्तेमाल करें, ड्राई पार्टीशन नहीं",
    ],
    benefits: [
    ...
    benefitsHi: [
      "कोई मेसनरी नहीं, गीला काम नहीं, लंबा क्योरिंग समय नहीं — कमरा हफ्तों नहीं, दिनों में बंट जाता है",
      "जिप्सम पार्टीशन पर पेंट, वॉलपेपर या दीवार पर लगने वाली चीज़ें बिल्कुल सामान्य दीवार जैसे लगती हैं",
      ...
      "जिप्सम पार्टीशन के अंदर एकॉस्टिक इनफिल (रॉकवूल) डालकर केबिनों के बीच सच में शोर कम किया जा सकता है",
    ],
    limitations: [
    ...
    limitationsHi: [
      "यह स्ट्रक्चरल दीवार नहीं है — इमारत का वज़न नहीं सह सकती",
      "जिप्सम साइड वॉटरप्रूफ नहीं है, जिप्सम सीलिंग जैसा ही नियम — गीली जगह में न लगाएं",
      "समान दीवार क्षेत्र के लिए ग्लास पार्टीशन, जिप्सम से काफी महंगा पड़ता है",
      "साधारण (गैर-एकॉस्टिक) जिप्सम पार्टीशन में साउंड आइसोलेशन मध्यम होती है, पूरी तरह साउंडप्रूफ नहीं",
    ],
    materials: [
      { name: "Metal stud framing", nameHi: "मेटल स्टड फ्रेमिंग", detail: "Floor and ceiling track with vertical studs at standard spacing — the skeleton of a gypsum partition", detailHi: "फर्श और छत की ट्रैक के साथ तय दूरी पर वर्टिकल स्टड — जिप्सम पार्टीशन का ढांचा" },
      ...
      { name: "Rockwool acoustic infill (optional)", nameHi: "रॉकवूल एकॉस्टिक इनफिल (वैकल्पिक)", detail: "Sound-absorbing insulation packed inside the stud cavity when noise reduction matters", detailHi: "जब शोर कम करना ज़रूरी हो, तो स्टड के बीच खाली जगह में साउंड-सोखने वाला इंसुलेशन भरा जाता है" },
      { name: "Toughened glass + aluminium frame", nameHi: "टफन्ड ग्लास + एल्युमिनियम फ्रेम", detail: "8–12mm toughened glass in an aluminium channel frame, plain, frosted, or with a fluted film finish", detailHi: "एल्युमिनियम चैनल फ्रेम में 8–12mm टफन्ड ग्लास, प्लेन, फ्रॉस्टेड या फ्लूटेड फिल्म फिनिश में" },
    ],
    installSteps: [
      ...
      { title: "Track & stud fixing (gypsum) / channel fixing (glass)", titleHi: "ट्रैक और स्टड फिक्सिंग (जिप्सम) / चैनल फिक्सिंग (ग्लास)", desc: "For gypsum: floor/ceiling tracks go up first, then vertical studs at set spacing. For glass: aluminium U-channels are fixed floor to ceiling.", descHi: "जिप्सम के लिए: पहले फर्श/छत की ट्रैक लगती है, फिर तय दूरी पर वर्टिकल स्टड। ग्लास के लिए: फर्श से छत तक एल्युमिनियम U-चैनल फिक्स होते हैं।" },
      ...
      { title: "Jointing/sealing & finishing", titleHi: "जॉइंटिंग/सीलिंग और फिनिशिंग", desc: "Gypsum: joints taped and puttied, then painted. Glass: joints silicone-sealed for a clean edge.", descHi: "जिप्सम: जोड़ों पर टेप-पुट्टी लगाकर पेंट किया जाता है। ग्लास: साफ किनारे के लिए जोड़ों पर सिलिकॉन सील लगाई जाती है।" },
    ...
    realProject: {
      ...
      descHi: "300 वर्ग फुट के किराए के ऑफिस फ्लोर को रॉकवूल भरे जिप्सम पार्टीशन से दो प्राइवेट केबिन और फ्रॉस्टेड-फिल्म ग्लास स्क्रीन से एक साझा रिसेप्शन में बांटा गया, ताकि सामने का हिस्सा खुला-खुला महसूस हो।",
      photos: 20,
    },
    faqs: [
      { q: "Can a partition wall support a wall-mounted TV or shelves?", qHi: "क्या पार्टीशन वॉल पर TV या शेल्फ लगाई जा सकती है?", a: "Yes, if we know in advance — we add extra wooden/metal backing blocking inside the frame at the exact height you'll mount things, so the screws bite into solid backing rather than just the board. Tell us this at the site-visit stage.", aHi: "हां, अगर पहले से पता हो — हम फ्रेम के अंदर उसी ऊंचाई पर लकड़ी/मेटल की अतिरिक्त बैकिंग लगा देते हैं जहां आप चीज़ें लगाना चाहते हैं, ताकि स्क्रू सिर्फ बोर्ड में नहीं, ठोस बैकिंग में लगे। यह बात साइट-विज़िट के समय ही बता दें।" },
      { q: "How much sound does a gypsum partition actually block?", qHi: "जिप्सम पार्टीशन असल में कितना शोर रोकती है?", a: "A plain double-layer gypsum partition cuts down normal conversation noise noticeably but isn't soundproof. Adding rockwool infill inside the cavity improves it meaningfully — enough for adjacent office cabins, not enough for a recording studio.", aHi: "साधारण डबल-लेयर जिप्सम पार्टीशन सामान्य बातचीत का शोर काफी हद तक कम कर देती है, पर पूरी तरह साउंडप्रूफ नहीं होती। खाली जगह में रॉकवूल डालने से यह काफी बेहतर हो जाता है — बगल के ऑफिस केबिन के लिए काफी, पर रिकॉर्डिंग स्टूडियो के लिए नहीं।" },
      { q: "Is glass partition safe with kids around?", qHi: "क्या घर में बच्चे हों तो ग्लास पार्टीशन सुरक्षित है?", a: "We use toughened glass as standard, which breaks into small blunt pieces rather than sharp shards if it ever cracks. For homes with young children we additionally recommend a safety-laminated film on the glass — ask for it specifically when we quote.", aHi: "हम स्टैंडर्ड में टफन्ड ग्लास इस्तेमाल करते हैं, जो टूटने पर तेज़ धार वाले टुकड़ों की जगह छोटे-कुंद टुकड़ों में टूटता है। छोटे बच्चों वाले घरों के लिए हम अतिरिक्त सेफ्टी-लैमिनेटेड फिल्म की भी सलाह देते हैं — कोटेशन लेते समय इसके लिए खासतौर पर पूछें।" },
    ],
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    priceTiers: [
      ...
      { tier: "Premium", tierHi: "प्रीमियम", range: "₹390–₹650/sq.ft", desc: "Fluted/louvre premium textures with an LED backlight channel, 18–25mm profile depth.", descHi: "LED बैकलाइट चैनल के साथ फ्लूटेड/लूवर प्रीमियम टेक्सचर, 18–25mm प्रोफाइल डेप्थ।" },
    ],
    ...
    sizesThicknessHi: "पैनल स्टैंडर्ड 250mm–600mm चौड़ाई और 8ft/10ft लंबाई में आते हैं, आपकी दीवार के साइज़ पर साइट पर काटे जाते हैं। मोटाई/प्रोफाइल डेप्थ प्लेन में 8mm से फ्लूटेड/लूवर डिज़ाइन में 18–25mm तक।",
    ...
    labourCostHi: "लेबर (बैटन फिक्सिंग, पैनल क्लिपिंग, ट्रिम्स, LED वायरिंग अगर हो) करीब ₹25–45/sq.ft, रेट में शामिल — फ्लूटेड/लूवर डिज़ाइन में प्लेन पैनल से ज़्यादा समय लगता है।",
    ...
    brandNoteHi: "WPC बोर्ड अधिकृत डीलरों से ISI-अनुरूप ब्रांडेड कम्पोजिट स्टॉक होते हैं — कुछ लोकल मार्केट में खुले बिकने वाले पतले अनब्रांडेड WPC नहीं, जो जल्दी मुड़ते हैं। साइट विज़िट में सही ब्रांड और टेक्सचर सैंपल दिखाया जाता है।",
    ...
    whereNotUsedHi: [
      "सीलिंग — WPC दीवार का प्रोडक्ट है; ऊपर के लिए PVC या जिप्सम इस्तेमाल करें",
      "पूरी तरह डूबी रहने वाली या लगातार गीली सतह — यह नमी-रोधी है, खड़े पानी के लिए नहीं",
      "लोड-बेयरिंग या स्ट्रक्चरल इस्तेमाल — यह क्लैडिंग फिनिश है, खुद दीवार नहीं",
    ],
    benefits: [
    ...
    benefitsHi: [
      ...
      "50+ रंग और टेक्सचर उपलब्ध, ट्रेंडिंग फ्लूटेड/लूवर प्रोफाइल समेत",
    ],
    limitations: [
    ...
    limitationsHi: [
      ...
      "जिप्सम के मुकाबले कस्टम शेपिंग सीमित — यह फ्लैट/फ्लूटेड पैनल सिस्टम है, ढलने वाली सतह नहीं",
      "गहरा खरोंच या चोट लगे पैनल को टच-अप से नहीं, उस हिस्से को बदलकर ठीक किया जाता है",
    ],
    materials: [
      { name: "WPC panel board", nameHi: "WPC पैनल बोर्ड", detail: "Wood-fibre + polymer composite core, in plain, wood-grain, fluted, or 3D-textured surface finishes", detailHi: "वुड-फाइबर + पॉलिमर कम्पोजिट कोर, प्लेन, वुड-ग्रेन, फ्लूटेड या 3D टेक्सचर सतह फिनिश में" },
      { name: "Vertical batten/clip system", nameHi: "वर्टिकल बैटन/क्लिप सिस्टम", detail: "Battens fixed to the wall at set spacing; panels clip in without face-fixing", detailHi: "दीवार पर तय दूरी पर लगी बैटन; पैनल बिना सामने से फिक्स किए क्लिप हो जाते हैं" },
    ...
    installSteps: [
      ...
      { title: "Panel cutting & clipping", titleHi: "पैनल कटिंग और क्लिपिंग", desc: "Panels are cut to size and clip-fixed onto the battens one after another, tongue-and-groove aligned.", descHi: "पैनल को नाप के हिसाब से काटकर बैटन में एक-एक करके क्लिप किया जाता है, टंग-एंड-ग्रूव से मिलाकर।" },
      ...
      { title: "Final wipe & handover", titleHi: "फाइनल सफाई और हैंडओवर", desc: "Panels wiped clean; no drying or curing time needed before the wall is ready to use.", descHi: "पैनल पोंछकर साफ किए जाते हैं; इस्तेमाल से पहले सूखने या क्योरिंग का कोई इंतज़ार नहीं करना पड़ता।" },
    ],
    realProject: {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    priceTiers: [
      ...
      { tier: "Standard", tierHi: "स्टैंडर्ड", range: "₹65–₹85/sq.ft", desc: "Better veining pattern, higher-gloss finish, 4mm thickness.", descHi: "बेहतर वेनिंग पैटर्न, ज़्यादा ग्लॉस फिनिश, 4mm मोटाई।" },
      { tier: "Premium", tierHi: "प्रीमियम", range: "₹90–₹120/sq.ft", desc: "Premium granite/exotic marble print, 5–6mm thickness, anti-fingerprint coating.", descHi: "प्रीमियम ग्रेनाइट/विदेशी मार्बल प्रिंट, 5–6mm मोटाई, एंटी-फिंगरप्रिंट कोटिंग।" },
    ],
    ...
    labourCostHi: "लेबर (सतह तैयार करना, एडहेसिव/क्लिप फिक्सिंग, एज बीडिंग) करीब ₹15–25/sq.ft, ऊपर के रेट में शामिल।",
    labourCostShort: "₹15–25/sq.ft",
    ...
    brandNoteHi: "UV मार्बल शीट पूर्णिया/फारबिसगंज के अधिकृत डीलरों से ISI-अनुरूप ब्रांडेड PVC-आधारित स्टॉक होती है — ऑर्डर से पहले साइट पर सैंपल बुक दिखाई जाती है ताकि असली शाइन और वेनिंग देख सकें।",
    ...
    limitationsHi: [
      ...
      "अगर रीसेल में असली पत्थर वाला प्रीमियम टैग खास मायने रखता हो, तो यह उतना प्रीमियम महसूस नहीं होता",
    ],
    materials: [
      ...
      { name: "Edge/corner beading", nameHi: "एज/कॉर्नर बीडिंग", detail: "Matching trims finish exposed edges and internal corners for a seamless read", detailHi: "मैचिंग ट्रिम खुले किनारों और अंदरूनी कोनों को बिना जोड़ वाली लुक देते हैं" },
    ],
    installSteps: [
      { title: "Wall preparation", titleHi: "दीवार की तैयारी", desc: "The wall is cleaned, cracks filled, and levelled so the sheet bonds flat with no bubbling.", descHi: "दीवार साफ की जाती है, दरारें भरी जाती हैं और लेवल की जाती है ताकि शीट बिना उभार के फ्लैट चिपके।" },
      ...
      { title: "Joint alignment", titleHi: "जोड़ मिलान", desc: "Adjacent sheets are pressed and aligned so the marble veining reads as continuous, not obviously tiled.", descHi: "पास-पास की शीट को दबाकर इस तरह मिलाया जाता है कि मार्बल की नसें लगातार दिखें, टाइल जैसी अलग-अलग नहीं।" },
      ...
      { title: "Final polish & handover", titleHi: "फाइनल पॉलिश और हैंडओवर", desc: "A final wipe-down brings up the gloss; the wall is ready to use immediately, no curing wait.", descHi: "आखिरी बार पोंछने से ग्लॉस निखर आता है; दीवार तुरंत इस्तेमाल के लिए तैयार होती है, क्योरिंग का इंतज़ार नहीं करना पड़ता।" },
    ],
    realProject: {
      ...
      descHi: "एक छोटा पूजा घर फर्श से छत तक सफेद-सुनहरी नसों वाली UV मार्बल शीट में फिनिश किया गया, मूर्ति के लिए एक रिसेस्ड LED आला के साथ — एक ही दिन में पूरा, साइट पर पत्थर काटने की कोई धूल नहीं।",
      photos: 20,
    },
    faqs: [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    priceTiers: [
      ...
      { tier: "Premium", tierHi: "प्रीमियम", range: "₹46,000–₹75,000+", desc: "10–14 ft unit, premium veneer/high-gloss finish, integrated LED backlight, extended storage and floating shelves.", descHi: "10–14 फुट यूनिट, प्रीमियम वीनियर/हाई-ग्लॉस फिनिश, बिल्ट-इन LED बैकलाइट, बड़ा स्टोरेज और फ्लोटिंग शेल्फ।" },
    ],
    ...
    sizesThicknessHi: "यूनिट फिक्स्ड साइज़ नहीं, आपकी दीवार की सही चौड़ाई (आमतौर पर 6–14 फुट) पर कस्टम बनती है। कारकास 18mm प्लाईवुड/MDF, बैक पैनल 6mm, लैमिनेट फेस शीट करीब 1mm — शटर और शेल्फ की मोटाई डिज़ाइन पर निर्भर।",
    ...
    labourCostHi: "फैब्रिकेशन और इंस्टॉलेशन लेबर ऊपर की यूनिट कीमत में शामिल है, अलग से बिल नहीं होता — यह आमतौर पर कुल का 25–35% हिस्सा होता है, ज़्यादा LED वर्क या फ्लोटिंग शेल्फ वाली यूनिट में थोड़ा ज़्यादा।",
    ...
    brandNoteHi: "कारकास मटेरियल ISI-अनुरूप ब्रांडेड स्टॉक का BWP/BWR-ग्रेड प्लाईवुड या MDF होता है, ब्रांडेड लैमिनेट/वीनियर शीट और सॉफ्ट-क्लोज़ हिंज/चैनल हार्डवेयर के साथ — डिज़ाइन स्टेज पर सही ब्रांड विकल्प दिखाए जाते हैं ताकि आप बजट में चुन सकें।",
    ...
    whatItIsHi:
      "मॉड्यूलर TV यूनिट एक कस्टम-निर्मित कैबिनेट सिस्टम है — कारकास, शटर, खुली शेल्फ और लैमिनेट या वीनियर फिनिश — जो आपकी दीवार की सही चौड़ाई और TV के साइज़ के हिसाब से बनाया जाता है, न कि किसी फिक्स्ड-साइज़ शोरूम पीस से। केबल रूटिंग डिज़ाइन स्टेज से ही पैनल में शामिल की जाती है, ताकि TV, सेट-टॉप बॉक्स और स्पीकर के तार यूनिट के पीछे छुप जाएं, सामने लटकते न दिखें।",
    whereUsed: [
    ...
    whereUsedHi: [
      ...
      "बेडरूम — बिस्तर के सामने एक कॉम्पैक्ट यूनिट",
    ...
    materials: [
      { name: "Plywood/MDF carcass", nameHi: "प्लाईवुड/MDF कारकास", detail: "The structural box of the unit — plywood for higher load areas, MDF where a smoother laminate finish is wanted", detailHi: "यूनिट का ढांचा — ज़्यादा वज़न वाली जगह के लिए प्लाईवुड, स्मूथ लैमिनेट फिनिश के लिए MDF" },
      ...
      { name: "LED strip + driver (optional)", nameHi: "LED स्ट्रिप + ड्राइवर (वैकल्पिक)", detail: "Backlight fitted along shelf edges or the back panel for a floating, showroom effect", detailHi: "शेल्फ के किनारों या पीछे के पैनल पर लगी बैकलाइट, फ्लोटिंग शोरूम जैसा असर देती है" },
    ],
    installSteps: [
      ...
      { title: "Module fabrication", titleHi: "मॉड्यूल फैब्रिकेशन", desc: "Carcass panels are cut, edge-banded, and laminated to the agreed finish, either at our workshop or on-site.", descHi: "कारकास पैनल काटे जाते हैं, एज-बैंड किए जाते हैं और तय फिनिश में लैमिनेट किए जाते हैं, हमारी वर्कशॉप या साइट पर।" },
      ...
      { title: "Module installation", titleHi: "मॉड्यूल इंस्टॉलेशन", desc: "Modules are installed and levelled, with the cable-management channel routed behind the panel.", descHi: "मॉड्यूल को इंस्टॉल और लेवल किया जाता है, केबल-मैनेजमेंट चैनल पैनल के पीछे से निकाली जाती है।" },
    ...
    realProject: {
      ...
      descHi: "10 फुट की दीवार पर लगी यूनिट, बीच में फ्लोटिंग शेल्फ, छुपी LED स्ट्रिप, और साइड में बंद कैबिनेट खासतौर पर मौजूदा सेट-टॉप बॉक्स और राउटर को नज़र से छुपाने के लिए बनाई गई।",
      photos: 8,
    },
    faqs: [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    materials: [
      ...
      { name: "Drainage underlay", nameHi: "ड्रेनेज अंडरले", detail: "A sand/gravel or perforated base layer laid beneath floor turf so rainwater passes through instead of pooling", detailHi: "फर्श वाली टर्फ के नीचे बिछाई गई रेत/बजरी या छिद्रित बेस लेयर, ताकि बारिश का पानी जमा होने की बजाय निकल जाए" },
      { name: "Jointing tape / seam adhesive", nameHi: "जॉइंटिंग टेप / सीम एडहेसिव", detail: "Joins adjacent turf rolls invisibly so the lawn reads as one continuous surface", detailHi: "पास-पास बिछाई गई टर्फ रोल को इस तरह जोड़ता है कि पूरा लॉन एक जैसा लगातार दिखे" },
    ],
    installSteps: [
    ...
    realProject: {
      ...
      descHi: "60 वर्ग फुट की बालकनी में ड्रेन्ड-बेस आर्टिफिशियल लॉन और गमलों का एक छोटा कोना बनाया गया — फ्लोर-लेवल फ्लैट में बगीचे जैसा एहसास चाहने वाले परिवार का समाधान, बिना असली बगीचा बनाए रखने की मेहनत के।",
      photos: 7,
    },
    faqs: [
