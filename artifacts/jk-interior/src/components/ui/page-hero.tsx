  ...
  return (
    <section className="relative overflow-hidden pt-36 pb-12 sm:pb-14">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-5 sm:px-6 lg:px-12">
        ...
        <h1 className="mb-3 font-serif text-3xl font-black leading-tight tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">
          {title}
        </h1>

        <p className="mb-7 max-w-2xl text-base leading-relaxed text-gray-600 sm:text-lg">
          {subtitle}
        </p>
