...
const trustBadges = [
  { icon: Star, label: "5-Star Rated", color: "text-amber-400", bg: "bg-amber-500/10 border-amber-500/20" },
...
const serviceCards = [
  { icon: Layers, title: "False Ceiling", desc: "PVC & Gypsum Experts", color: "from-blue-500 to-blue-700" },
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        ...
        {!shouldReduce && (
          <>
            <motion.div
              className="absolute -top-40 left-1/3 h-[500px] w-[500px] rounded-full bg-blue-600/15 blur-[100px]"
              animate={{ opacity: [0.4, 0.7, 0.4], scale: [0.9, 1.05, 0.9] }}
              transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
            />
            <motion.div
              className="absolute top-1/3 -right-20 h-96 w-96 rounded-full bg-blue-800/20 blur-[80px]"
          ...
          <div className="lg:col-span-7">
            ...
            <motion.div {...anim(0.15)} className="mb-5">
              ...
              <motion.div
                ...
                className="mt-3 h-1 w-24 origin-left rounded-full bg-gradient-to-r from-blue-500 via-amber-400 to-blue-500"
              />
            </motion.div>

            {/* Animated Subheadline */}
            <motion.div {...anim(0.25)} className="mb-5 h-10 sm:h-12">
              <div className="text-lg font-bold text-slate-400 sm:text-xl md:text-2xl flex items-center gap-2 flex-wrap">
